...
INSERT INTO `categories` (`id`, `name`, `descp`, `user_id`, `type`, `status`, `created_at`) VALUES
(1, 'Technical', NULL, 1, 'blog', 0, '2017-07-31 15:03:14'),
(2, 'Business', NULL, 1, 'blog', 0, '2017-07-31 15:03:14'),
(4, '2021 DJ Remix', '<p>2021 DJ Remix 2021 DJ Remix</p>\r\n', 3, 'product', 1, '2017-08-10 14:49:47'),
(5, 'Punjabi Mp3', '<p>Punjabi Mp3 Punjabi Mp3 Punjabi Mp3</p>\r\n', 3, 'product', 1, '2017-08-10 14:51:38'),
(6, 'FAQ Category Onee', NULL, 1, 'faq', 1, '2017-08-14 15:00:07'),
(7, 'FAQ Category two', NULL, 1, 'faq', 1, '2017-08-14 15:11:39'),
(8, 'New  Bollwood Mp3', '<p>New&nbsp; Bollwood Mp3 New&nbsp; Bollwood Mp3 New&nbsp; Bollwood Mp3 New&nbsp; Bollwood Mp3</p>\r\n', 1, 'product', 1, '2021-11-03 14:24:37'),
(9, '2021 Mp3 Songs', '<p>2021 Mp3 Songs 2021 Mp3 Songs 2021 Mp3 Songs</p>\r\n', 1, 'product', 1, '2021-11-03 14:24:51'),
(10, 'Hindi Movie 2021', '<p>Hindi Movie 2021 Hindi Movie 2021 Hindi Movie 2021 Hindi Movie 2021</p>\r\n', 1, 'product', 1, '2021-11-03 14:25:05'),
(11, '2021 Bhojpuri Mp', '<p>2021 Bhojpuri Mp 2021 Bhojpuri Mp 2021 Bhojpuri Mp 2021 Bhojpuri Mp</p>\r\n', 1, 'product', 1, '2021-11-03 14:25:26');
...
(1, 'E commerce Site', 'BigSongs.In_p.png', 'E commerce Site');
...
DROP TABLE IF EXISTS `sliders_img`;
CREATE TABLE IF NOT EXISTS `sliders_img` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `description` varchar(255) NOT NULL,
...
(1, 'Administrator', 'waqarjan333@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'admin', '9898989898', 'Admin Nagar', 'Male', 'YADU_Logo.JPG', 1, '23232', '1990-08-03', 1, '2021-11-05 07:12:02'),
(4, 'Ahsan Elahi', 'mr.elahi.ehsan@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'ahsanelahi', '9898989898', 'durga nagar asas', 'Male', 'slide_05.jpg', 1, '23232', '1990-08-03', 1, '2017-08-09 18:49:15');
COMMIT;
